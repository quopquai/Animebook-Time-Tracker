// amazonprime-bridge.js — Animebook Time Tracker v4.4
// Runs in ISOLATED world.

if (!window.__animebookAmazonBridgeLoaded) {
  window.__animebookAmazonBridgeLoaded = true;
